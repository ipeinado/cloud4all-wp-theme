...
(function(){var i,t;t={"class":"tooltip"},i=$("<div>",t),$(function(){var t,n;return t=$(".main-navigation").offset().top,n=$("#page").width()-48,$(window).scroll(function(){return $(window).scrollTop()>t?n>600?$(".main-navigation").css({position:"fixed",top:0,width:n}):void 0:$(".main-navigation").css({position:"static",top:"0px"})}),$("#video-play-link").click(function(i){return i.preventDefault(),$("#video-overlay").hide(),$("#home-video").trigger("play")}),$(".tooltips").hover(function(){return $(i).text(this.dataset.info),$(this).parent("li").append(i),$(i).css("display","block")},function(){return $(i).css("display","none")})})}).call(this);
(function(){var t,e,a,r,o,n,c,l,d;r="Drag one of the cards over the NFC reader in the right and see how the contents will autoadapt to the user's needs and preferences.",o="Sammy likes high contrast. Move Sammy's card over the NFC reader on the right to see how the page adapts to his needs.",n="You are now keyed in as Sammy. If you want to key out and get back to the normal page, move Sammy's card over the NFC reader",e="Carla likes big fonts and no images. Move Carla's card over the NFC reader on the right to see how the page adapts to her needs",a="You are now keyed in as Carla. If you want to key out and get back to the normal page, move Carla's card over the NFC reader",t=r,d=d||!1,c={containment:"#cards-banner",cursor:"move",revert:!0,stop:function(){return $("#card-tooltip-text").html(t)}},l=function(e){return $.cookie("token",e,{path:"/"}),$("html").attr("token",e),"sammy"===e&&(t=n,$("#card-sammy").addClass("active"),$("#card-carla").removeClass("active")),"carla"===e&&(t=a,$("#card-carla").addClass("active"),$("#card-sammy").removeClass("active")),$("#card-tooltip-text").html(t)},$(function(){var a;return a=$.cookie("token"),typeof a===!1&&a===!0?(d=!1,console.log("no token")):(d=!0,console.log(a),l(a)),$("#card-sammy").hover(function(){return $("#card-tooltip-text").html(o)},function(){return $("#card-tooltip-text").html(t)}),$("#card-carla").hover(function(){return $("#card-tooltip-text").html(e)},function(){return $("#card-tooltip-text").html(t)}),$("#card-sammy").draggable(c),$("#card-carla").draggable(c),$("#nfc-reader").droppable({tolerance:"fit",activeClass:"active",over:function(e,o){return d===!0?a===o.draggable.attr("data-token")?($("html").removeAttr("token"),$("#card-tooltip-text").html("<br />KEYING OUT...<br />"),console.log("keying out "+a),d=!1,t=r,$.cookie("token",null,{path:"/"}),$.removeCookie("token",{path:"/"}),$("#card-sammy").removeClass("active"),$("#card-carla").removeClass("active")):($("#card-tooltip-text").html("<br />KEYING IN...<br />"),a=o.draggable.attr("data-token"),l(a)):($("#card-tooltip-text").html("<br />KEYING IN...<br />"),d=!0,a=o.draggable.attr("data-token"),l(a))}})})}).call(this);
(function(){var t,r,c,a,e,i;$(function(){return $(window).width()>600?(c(),$("#GPII > a").click(function(t){return t.preventDefault(),c()}),$("#C4a > a").click(function(t){return t.preventDefault(),r()}),$("#P4a > a").click(function(t){return t.preventDefault(),a()}),$("#used > a").click(function(t){return t.preventDefault(),i()}),$("#uiita > a").click(function(t){return t.preventDefault(),e()})):void 0}),t=function(){return $("#gpii-blocks li div").removeAttr("prjct"),$("#gpii-page-menu li").removeClass("active"),$("#GPII-text").hide(),$("#cloud4all-text").hide(),$("#p4a-text").hide(),$("#used-text").hide(),$("#rerc-text").hide()},c=function(){return t(),$("#GPII").addClass("active"),$("#GPII-text").show()},r=function(){return t(),$("#C4a").addClass("active"),$("#block-3 > div").attr("prjct","C4a"),$("#block-4 > div.block-title").attr("prjct","C4a"),$("#block-6 > div").attr("prjct","C4a"),$("#block-7 > div").attr("prjct","C4a"),$("#block-8 > div").attr("prjct","C4a"),$("#cloud4all-text").show()},a=function(){return t(),$("#P4a").addClass("active"),$("#block-4 > div.block-descr").attr("prjct","P4a"),$("#block-9 > div").attr("prjct","P4a"),$("#block-10 > div").attr("prjct","P4a"),$("#block-11 > div").attr("prjct","P4a"),$("#block-12 > div").attr("prjct","P4a"),$("#block-13 > div").attr("prjct","P4a"),$("#block-14 > div").attr("prjct","P4a"),$("#block-15 > div").attr("prjct","P4a"),$("#p4a-text").show()},i=function(){return t(),$("#used").addClass("active"),$("#block-2 > div").attr("prjct","used"),$("#used-text").show()},e=function(){return t(),$("#uiita").addClass("active"),$("#block-5 > div").attr("prjct","rerc"),$("#rerc-text").show()}}).call(this);